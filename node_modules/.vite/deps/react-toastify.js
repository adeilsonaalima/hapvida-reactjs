...
function cssTransition(_ref) {
  ...
  return function ToastTransition(_ref2) {
    ...
    const baseClassName = (0, import_react.useRef)();
...
function Warning(props) {
  return import_react.default.createElement(Svg, __spreadValues({}, props), import_react.default.createElement("path", {
...
function ProgressBar(_ref) {
  ...
  const style = __spreadProps(__spreadValues({}, userStyle), {
  ...
  return import_react.default.createElement("div", __spreadValues({
    role: "progressbar",
...
var Toast = (props) => {
  ...
  return import_react.default.createElement(Transition, {
    ...
    preventExitTransition,
    nodeRef: toastRef
  }, import_react.default.createElement("div", __spreadProps(__spreadValues({
    id: toastId,
    onClick,
    ...
    style,
    ref: toastRef
  }), import_react.default.createElement("div", __spreadProps(__spreadValues({}, isIn && {
    role
  }), {
  ...
  }, iconOut), import_react.default.createElement("div", null, children)), Close, (autoClose || isProgressControlled) && import_react.default.createElement(ProgressBar, __spreadProps(__spreadValues({}, updateId && !isProgressControlled ? {
    key: "pb-" + updateId
  } : {}), {
    rtl,
    theme,
...
var ToastContainer = (0, import_react.forwardRef)((props, ref) => {
  ...
  return import_react.default.createElement("div", {
    ...
    const containerStyle = !toastList.length ? __spreadProps(__spreadValues({}, style), {
      pointerEvents: "none"
    ...
    return import_react.default.createElement("div", {
      ...
      return import_react.default.createElement(Toast, __spreadProps(__spreadValues({}, toastProps), {
        isIn: isToastActive(toastProps.toastId),
        style: __spreadProps(__spreadValues({}, toastProps.style), {
          "--nth": i + 1,
...
toast.loading = (content, options) => dispatchToast(content, mergeOptions(TYPE.DEFAULT, __spreadValues({
  isLoading: true,
  autoClose: false,
  closeOnClick: false,
  closeButton: false,
...
function handlePromise(promise, _ref2, options) {
  ...
  const resolver = (type, input, result) => {
    ...
    if (id) {
      toast.update(id, __spreadValues(__spreadValues({}, baseParams), params));
    } else {
      toast(params.render, __spreadValues(__spreadValues({}, baseParams), params));
    }
    return result;
  };
...
toast.dark = (content, options) => dispatchToast(content, mergeOptions(TYPE.DEFAULT, __spreadValues({
  theme: "dark"
}, options)));
